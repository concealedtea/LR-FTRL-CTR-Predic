    ...
    for i in ls_feature_positions:
        ...
        for q in range (0,loop):
                ...
                with open(path_file_train, "r", encoding = "utf-8") as fi:
                    for line in fi:
                        if line.strip():
                            ...
                            if clk > 1:
                                clk = 1
                            ls_sub_features = [ls_features[q] for q in ls_test]
            ...
            if logloss < current_logloss:
                ...
                pass
        print ("Result:", i, current_auc, current_logloss) # Print Best LogLoss
        ls_best_score.append((i, current_auc, current_logloss))
    """
